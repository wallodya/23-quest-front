...
export const CreateQuestCard = () => {
    return (
        <div className=" mb-8 gap-4 rounded-lg border border-gray-200 bg-gray-50 p-8 dark:border-gray-700 dark:bg-gray-800 md:p-12">
            <div className="grid grid-cols-[repeat(auto-fit,minmax(400px,1fr))] mb-4">
                <div>
